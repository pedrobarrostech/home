...
function intervalHandler () {
  ...
  context.beginPath()
  context.fillRect(width * 0.5, height * 0.5, 1, 1)
  context.closePath()
  context.fill()
...
function ParticleObject (pIndex, pX, pY) {
  ...
  this.draw = function () {
    ...
    this.radgrad.addColorStop(0.8, '#FF0000')
...
function animateBGColor (lastIndex, rand) {
  var colors = ['#000000', '#003300', '#663300', '#993333', '#660066', '#000066', '#006699', '#003366', '#ffffff']
  var length = colors.length
  var nextColor = 'black'
  var nextIndex = 0
  if (rand) {
    nextColor = colors[Math.floor(Math.random() * length)]
  } else {
